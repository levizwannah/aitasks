...
g.add_node("SportsComplex", pos=(-6, 12))
g.add_node("Siwaka", pos=(-3, 18))
g.add_node("Ph.1A", pos=(6, 18))
g.add_node("Ph.1B", pos=(6, 12))
g.add_node("Phase2", pos=(14, 12))
g.add_node("J1", pos=(22, 12))
g.add_node("Mada", pos=(30, 12))
